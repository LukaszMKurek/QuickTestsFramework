...
{
   [TestFixture]
   public sealed class ThrowAssertPassTests
   {
      private ThrowAssertPassTestsInternal _ut;

      [TestFixtureSetUp]
      public void SetUp()
      {
         _ut = new ThrowAssertPassTestsInternal();
...
ExceptionBeforeRun; before;", typeof(SuccessException), @"Assert.Pass message");
      }
